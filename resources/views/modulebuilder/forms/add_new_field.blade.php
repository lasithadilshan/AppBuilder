...
<!--                                <select class="form-control  select2_multiple" multiple='multiple' name="field_options" id="field_options" style='width: 100%'>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input ng-model='field.field_length' type="text" id="field_length" name='field_length'  class="form-control col-md-7 col-xs-12" >
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <input ng-model='field.show_in_list' type="radio"  name='show_in_list' value="1" checked="checked"> yes
