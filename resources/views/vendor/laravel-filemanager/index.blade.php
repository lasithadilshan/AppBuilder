@extends('layouts.filemanagerLayout')
@section('head')
  ...
  <script>
    $.fn.fab = function () {
      ...
      parent_button.addClass('mfb-component__button--main')
        .append($('<i>').addClass('mfb-component__main-icon--resting fa fa-plus modifyicon'))
        .append($('<i>').addClass('mfb-component__main-icon--active fa fa-times modifyicon'));
